...
def load_sis(path):
    ...
    print ('former_length', former_length)
...
#     print ('first_keys["vid"]', data[first_keys][0]['vid'])
#     print ('first_keys["vid"]', data[first_keys][1]['vid'])
#     print ('first_keys["vid"]', data[first_keys][2]['vid'])
#     print ('first_keys["vid"]', data[first_keys][3]['vid'])
#     print ('first_keys["vid"]', data[first_keys][4]['vid'])
    
#     print ('second_keys["vid"]', data[second_keys][0]['vid'])
#     print ('second_keys["vid"]', data[second_keys][1]['vid'])
#     print ('second_keys["vid"]', data[second_keys][2]['vid'])
#     print ('second_keys["vid"]', data[second_keys][3]['vid'])
#     print ('second_keys["vid"]', data[second_keys][4]['vid'])    

#     # save data to pkl
#     datafile_path = feature_path / f'{mode}_VIST_dict.pkl'
